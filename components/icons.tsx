...
export const CoffeeCupIcon: React.FC<{ className?: string, checked?: boolean }> = ({ className, checked = false }) => (
  <div className={`relative ${className}`}>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-full h-full">
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75" />
    </svg>
    {checked && (
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="absolute -top-1 -right-1 w-4 h-4 text-green-500 bg-coffee-dark rounded-full">
...
export const RefreshIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12c0-2.023-.9-3.84-2.35-5.129a7.5 7.5 0 0 0-10.3 0 7.5 7.5 0 0 0-2.35 5.129m2.35 0a7.5 7.5 0 0 1 10.3 0M4.5 12c0 2.023.9 3.84 2.35 5.129a7.5 7.5 0 0 0 10.3 0 7.5 7.5 0 0 0 2.35-5.129m-15.15.023h3.352m-3.352 0l1.104 2.208M19.5 12h-3.352m3.352 0l-1.104-2.208" />
    </svg>
);
...
export const ChatBubbleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.388m-5.182-1.232a7.469 7.469 0 01-.762-3.768 7.5 7.5 0 017.5-7.5c2.132 0 4.09.752 5.624 2.01L18.822 7.5M18.822 7.5L15 3.678M18.822 7.5l-3.822 3.822" />
    </svg>
);
